                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Riz Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Riz address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and riz: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Riz Core"), this);
    aboutAction->setStatusTip(tr("Show information about Riz Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Riz"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Riz addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Riz addresses"));
    ...
    openAction->setStatusTip(tr("Open a Riz: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Riz Core help message to get a list with possible Riz command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Riz Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Riz network", "", count));
}
...
{
    QString strTitle = tr("Riz Core"); // default title
