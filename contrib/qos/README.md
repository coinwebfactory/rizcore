...
This means one can have an always-on rizd instance running, and another local rizd/riz-qt instance which connects to this node and receives blocks from it.
