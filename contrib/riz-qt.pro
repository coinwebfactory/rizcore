...
RESOURCES += src/qt/riz.qrc src/qt/riz_locale.qrc

TRANSLATIONS += src/qt/locale/riz_bg.ts \
                src/qt/locale/riz_de.ts \
                src/qt/locale/riz_en.ts \
                src/qt/locale/riz_es.ts \
                src/qt/locale/riz_fi.ts \
                src/qt/locale/riz_fr.ts \
                src/qt/locale/riz_it.ts \
                src/qt/locale/riz_ja.ts \
                src/qt/locale/riz_pl.ts \
                src/qt/locale/riz_pt.ts \
                src/qt/locale/riz_ru.ts \
                src/qt/locale/riz_sk.ts \
                src/qt/locale/riz_sv.ts \
                src/qt/locale/riz_vi.ts \
                src/qt/locale/riz_zh_CN.ts \
                src/qt/locale/riz_zh_TW.ts
