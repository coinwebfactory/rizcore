...
In order to support loading of multiple wallets in riz-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is riz.cpp.
...
Changes to riz.cpp
----------------------
riz.cpp is the entry point into riz-qt, and as such, will require some minor modifications to provide hooks for
