...
* WebSocket: [https://github.com/AMS-Project/insight-api-riz#web-socket-api](https://github.com/AMS-Project/insight-api-riz#web-socket-api) 
* API: [https://github.com/AMS-Project/insight-api-riz#swifttx-transactions](https://github.com/AMS-Project/insight-api-riz#swifttx-transactions) 
...
By default, the AMS Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the AMS Core daemon:
