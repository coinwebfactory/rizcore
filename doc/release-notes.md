Riz Core version 2.2.1 is now available from:

  <https://github.com/riz-project/riz/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/riz-project/riz/issues>

Compatibility
==============

Riz Core is extensively tested on multiple operating systems using
...
Riz Core should also work on most other Unix-like systems but is not
...
of Bitcoin that Riz was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/riz-project-translations/).
