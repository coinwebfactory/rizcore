Contributing to Riz Core
============================

The Riz Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Riz Core project, and is not to be
confused with overall Riz Network Protocol consensus changes.

Whether a pull request is merged into Riz Core rests with the project merge
...
Patches that change Riz consensus rules are considerably more involved than
...
Where a patch set proposes to change the Riz consensus, it must have been
...
The project leader is the release manager for each Riz Core release.
